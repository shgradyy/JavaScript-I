...
const car33 =  Object.values(inventory[32]).slice(1);
console.log("Car 33 is a " + car33);
...
let carModels = inventory.map((car, index, inventory) => {
...
let carYears = inventory.map((year, index, inventory) => {
...
let Audi = inventory.filter((make) => {
    return make.car_make == "Audi" 
})
let BMW = inventory.filter((make) => {
    return make.car_make == "BMW" 
})
console.log(BMW);
console.log(Audi);
console.log(JSON.stringify(Audi + BMW));
